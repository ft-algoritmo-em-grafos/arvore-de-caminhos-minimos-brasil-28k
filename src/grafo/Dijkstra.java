...
class Dijkstra {
    ...
    public List<Vertice> encontrarMenorCaminhoDijkstra(Grafo grafo, Vertice v1,
        ...
        while (!this.naoVisitados.isEmpty()) {
            ...
            // da
            // lista
            Vertice alciomar = this.naoVisitados.get(0);
            ...
            for (int i = 0; i < atual.getArestas().size(); i++) {
                ...
                if (!vizinho.verificarVisita()) {
                    ...
                    // distância
                    System.out.println("vizinho.getDistancia():" + vizinho.getDistancia());
                    System.out.println("atual.getDistancia():" + atual.getDistancia());
                    System.out.println("atual.getArestas().get(i).getPeso()" + atual.getArestas().get(i).getPeso());
